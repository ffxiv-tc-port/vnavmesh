...
public unsafe static class LayoutUtils
{
    ...
    {
        // TC's client ships an older Lumina schema where TerritoryType has no ZoneSharedGroup column
        // (this data was added for the Gridania Roads content that postdates TC's current patch level).
        // No known workaround short of TC updating its game data - stubbed out until then.
        return [];
    }
